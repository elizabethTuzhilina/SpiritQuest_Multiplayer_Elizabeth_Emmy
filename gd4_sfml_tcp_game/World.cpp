...
void World::BuildScene()
{
	...
	// Add platforms
	std::vector<std::pair<TextureID, sf::Vector2f>> platforms = {
		{TextureID::kPlat1A, {0.f, 2200.f}},
		{TextureID::kPlat1B, {600.f, 2200.f}},
		{TextureID::kPlat2A, {300.f, 2000.f}},
		{TextureID::kPlat2B, {80.f, 1800.f}},
		{TextureID::kPlat2C, {700.f, 1750.f}},
		{TextureID::kPlat2D, {0.f, 1600.f}},
		{TextureID::kPlat2E, {800.f, 1550.f}},
		{TextureID::kPlat2F, {150.f, 1380.f}},
		{TextureID::kPlat2G, {0.f, 1150.f}},
		{TextureID::kPlat3,  {0.f, 0.f}}
	};

	for (const auto& [texture_id, pos] : platforms)
	{
		sf::Texture& tex = m_textures.Get(texture_id);
		std::unique_ptr<SpriteNode> sprite(new SpriteNode(tex));
		sprite->setPosition(pos);
		m_platforms.push_back(sprite.get());
